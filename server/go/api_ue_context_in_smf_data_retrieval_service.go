...
// UEContextInSMFDataRetrievalAPIService is a service that implements the logic for the UEContextInSMFDataRetrievalAPIServicer
// This service should implement the business logic for every endpoint for the UEContextInSMFDataRetrievalAPI API.
// Include any external packages or services that will be required by this service.
type UEContextInSMFDataRetrievalAPIService struct {
}

// NewUEContextInSMFDataRetrievalAPIService creates a default api service
func NewUEContextInSMFDataRetrievalAPIService() UEContextInSMFDataRetrievalAPIServicer {
	return &UEContextInSMFDataRetrievalAPIService{}
}

// GetUeCtxInSmfData - retrieve a UE&#39;s UE Context In SMF Data
func (s *UEContextInSMFDataRetrievalAPIService) GetUeCtxInSmfData(ctx context.Context, supi string, supportedFeatures string) (ImplResponse, error) {
	// TODO - update GetUeCtxInSmfData with the required logic for this service method.
	// Add api_ue_context_in_smf_data_retrieval_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, UeContextInSmfData{}) or use other options such as http.Ok ...
	// return Response(200, UeContextInSmfData{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetUeCtxInSmfData method not implemented")
}
