...
// AssertCombGciAndHfcNIdsRequired checks if the required fields are not zero-ed
func AssertCombGciAndHfcNIdsRequired(obj CombGciAndHfcNIds) error {
	return nil
}

// AssertCombGciAndHfcNIdsConstraints checks if the values respects the defined constraints
func AssertCombGciAndHfcNIdsConstraints(obj CombGciAndHfcNIds) error {
	return nil
}
