...
// ProvidingAcknowledgementOfCAGUpdateAPIService is a service that implements the logic for the ProvidingAcknowledgementOfCAGUpdateAPIServicer
// This service should implement the business logic for every endpoint for the ProvidingAcknowledgementOfCAGUpdateAPI API.
// Include any external packages or services that will be required by this service.
type ProvidingAcknowledgementOfCAGUpdateAPIService struct {
}

// NewProvidingAcknowledgementOfCAGUpdateAPIService creates a default api service
func NewProvidingAcknowledgementOfCAGUpdateAPIService() ProvidingAcknowledgementOfCAGUpdateAPIServicer {
	return &ProvidingAcknowledgementOfCAGUpdateAPIService{}
}

// CAGAck - Nudm_Sdm Info operation for CAG acknowledgement
func (s *ProvidingAcknowledgementOfCAGUpdateAPIService) CAGAck(ctx context.Context, supi string, acknowledgeInfo AcknowledgeInfo) (ImplResponse, error) {
	// TODO - update CAGAck with the required logic for this service method.
	// Add api_providing_acknowledgement_of_cag_update_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("CAGAck method not implemented")
}
