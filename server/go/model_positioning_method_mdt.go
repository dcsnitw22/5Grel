...
// AssertPositioningMethodMdtConstraints checks if the values respects the defined constraints
func AssertPositioningMethodMdtConstraints(obj PositioningMethodMdt) error {
	return nil
}
