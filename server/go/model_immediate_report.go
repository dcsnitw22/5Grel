...
// AssertImmediateReportRequired checks if the required fields are not zero-ed
func AssertImmediateReportRequired(obj ImmediateReport) error {
	...
	if err := AssertLcsSubscriptionDataRequired(obj.LcsSubscriptionData); err != nil {
		return err
	}
	...
	if err := AssertA2xSubscriptionDataRequired(obj.A2xData); err != nil {
		return err
	}
	return nil
}

// AssertImmediateReportConstraints checks if the values respects the defined constraints
func AssertImmediateReportConstraints(obj ImmediateReport) error {
	return nil
}
