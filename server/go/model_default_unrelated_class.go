...
// AssertDefaultUnrelatedClassRequired checks if the required fields are not zero-ed
func AssertDefaultUnrelatedClassRequired(obj DefaultUnrelatedClass) error {
...
// AssertDefaultUnrelatedClassConstraints checks if the values respects the defined constraints
func AssertDefaultUnrelatedClassConstraints(obj DefaultUnrelatedClass) error {
	return nil
}
