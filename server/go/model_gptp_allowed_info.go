...
// AssertGptpAllowedInfoRequired checks if the required fields are not zero-ed
func AssertGptpAllowedInfoRequired(obj GptpAllowedInfo) error {
	elements := map[string]interface{}{
		"gptpAllowed": obj.GptpAllowed,
	}
...
// AssertGptpAllowedInfoConstraints checks if the values respects the defined constraints
func AssertGptpAllowedInfoConstraints(obj GptpAllowedInfo) error {
