...
// TraceConfigurationDataRetrievalAPIService is a service that implements the logic for the TraceConfigurationDataRetrievalAPIServicer
// This service should implement the business logic for every endpoint for the TraceConfigurationDataRetrievalAPI API.
// Include any external packages or services that will be required by this service.
type TraceConfigurationDataRetrievalAPIService struct {
}

// NewTraceConfigurationDataRetrievalAPIService creates a default api service
func NewTraceConfigurationDataRetrievalAPIService() TraceConfigurationDataRetrievalAPIServicer {
	return &TraceConfigurationDataRetrievalAPIService{}
}

// GetTraceConfigData - retrieve a UE&#39;s Trace Configuration Data
func (s *TraceConfigurationDataRetrievalAPIService) GetTraceConfigData(ctx context.Context, supi string, supportedFeatures string, plmnId PlmnId, ifNoneMatch string, ifModifiedSince string) (ImplResponse, error) {
	// TODO - update GetTraceConfigData with the required logic for this service method.
	// Add api_trace_configuration_data_retrieval_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, TraceDataResponse{}) or use other options such as http.Ok ...
	// return Response(200, TraceDataResponse{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetTraceConfigData method not implemented")
}
