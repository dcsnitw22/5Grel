...
// LCSSubscriptionDataRetrievalAPIService is a service that implements the logic for the LCSSubscriptionDataRetrievalAPIServicer
// This service should implement the business logic for every endpoint for the LCSSubscriptionDataRetrievalAPI API.
// Include any external packages or services that will be required by this service.
type LCSSubscriptionDataRetrievalAPIService struct {
}

// NewLCSSubscriptionDataRetrievalAPIService creates a default api service
func NewLCSSubscriptionDataRetrievalAPIService() LCSSubscriptionDataRetrievalAPIServicer {
	return &LCSSubscriptionDataRetrievalAPIService{}
}

// GetLcsSubscriptionData - retrieve a UE&#39;s LCS Subscription Data
func (s *LCSSubscriptionDataRetrievalAPIService) GetLcsSubscriptionData(ctx context.Context, supi string, supportedFeatures string, ifNoneMatch string, ifModifiedSince string) (ImplResponse, error) {
	// TODO - update GetLcsSubscriptionData with the required logic for this service method.
	// Add api_lcs_subscription_data_retrieval_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, LcsSubscriptionData{}) or use other options such as http.Ok ...
	// return Response(200, LcsSubscriptionData{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetLcsSubscriptionData method not implemented")
}
