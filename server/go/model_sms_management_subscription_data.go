...
// AssertSmsManagementSubscriptionDataRequired checks if the required fields are not zero-ed
func AssertSmsManagementSubscriptionDataRequired(obj SmsManagementSubscriptionData) error {
...
// AssertSmsManagementSubscriptionDataConstraints checks if the values respects the defined constraints
func AssertSmsManagementSubscriptionDataConstraints(obj SmsManagementSubscriptionData) error {
	return nil
}
