...
// AssertModify200ResponseRequired checks if the required fields are not zero-ed
func AssertModify200ResponseRequired(obj Modify200Response) error {
...
// AssertModify200ResponseConstraints checks if the values respects the defined constraints
func AssertModify200ResponseConstraints(obj Modify200Response) error {
	return nil
}
