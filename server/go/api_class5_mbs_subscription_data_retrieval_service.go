...
// Class5MBSSubscriptionDataRetrievalAPIService is a service that implements the logic for the Class5MBSSubscriptionDataRetrievalAPIServicer
// This service should implement the business logic for every endpoint for the Class5MBSSubscriptionDataRetrievalAPI API.
// Include any external packages or services that will be required by this service.
type Class5MBSSubscriptionDataRetrievalAPIService struct {
}

// NewClass5MBSSubscriptionDataRetrievalAPIService creates a default api service
func NewClass5MBSSubscriptionDataRetrievalAPIService() Class5MBSSubscriptionDataRetrievalAPIServicer {
	return &Class5MBSSubscriptionDataRetrievalAPIService{}
}

// GetMbsData - retrieve a UE&#39;s 5MBS Subscription Data
func (s *Class5MBSSubscriptionDataRetrievalAPIService) GetMbsData(ctx context.Context, supi string, supportedFeatures string, ifNoneMatch string, ifModifiedSince string) (ImplResponse, error) {
	// TODO - update GetMbsData with the required logic for this service method.
	// Add api_class5_mbs_subscription_data_retrieval_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.

	// TODO: Uncomment the next line to return response Response(200, MbsSubscriptionData{}) or use other options such as http.Ok ...
	// return Response(200, MbsSubscriptionData{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetMbsData method not implemented")
}
