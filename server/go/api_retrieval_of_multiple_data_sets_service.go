...
func (s *RetrievalOfMultipleDataSetsAPIService) GetDataSets(ctx context.Context, supi string, datasetNames []DataSetName, plmnId PlmnIdNid, adjacentPlmns []PlmnId, singleNssai Snssai, dnn string, ucPurpose UcPurpose, disasterRoamingInd bool, supportedFeatures string, ifNoneMatch string, ifModifiedSince string) (ImplResponse, error) {
