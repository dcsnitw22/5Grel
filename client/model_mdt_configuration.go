...
type _MdtConfiguration MdtConfiguration
...
func (o *MdtConfiguration) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMdtConfiguration := _MdtConfiguration{}

	err = json.Unmarshal(bytes, &varMdtConfiguration)

	if err != nil {
		return err
	}

	*o = MdtConfiguration(varMdtConfiguration)
