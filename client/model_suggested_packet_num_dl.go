...
type _SuggestedPacketNumDl SuggestedPacketNumDl
...
func (o *SuggestedPacketNumDl) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSuggestedPacketNumDl := _SuggestedPacketNumDl{}

	err = json.Unmarshal(bytes, &varSuggestedPacketNumDl)

	if err != nil {
		return err
	}

	*o = SuggestedPacketNumDl(varSuggestedPacketNumDl)
