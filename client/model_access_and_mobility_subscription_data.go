...
func (o *AccessAndMobilitySubscriptionData) GetSubscribedUeAmbr() Ambr {
	if o == nil || IsNil(o.SubscribedUeAmbr.Get()) {
		var ret Ambr
		return ret
	}
	return *o.SubscribedUeAmbr.Get()
}
...
func (o *AccessAndMobilitySubscriptionData) GetSubscribedUeAmbrOk() (*Ambr, bool) {
	...
	return o.SubscribedUeAmbr.Get(), o.SubscribedUeAmbr.IsSet()
}
...
func (o *AccessAndMobilitySubscriptionData) HasSubscribedUeAmbr() bool {
	if o != nil && o.SubscribedUeAmbr.IsSet() {
		return true
	}
...
func (o *AccessAndMobilitySubscriptionData) GetAun3DeviceConnectivityAllowed() bool {
	if o == nil || IsNil(o.Aun3DeviceConnectivityAllowed) {
		var ret bool
		return ret
	}
...
func (o *AccessAndMobilitySubscriptionData) GetSharedDataList() []SharedData {
	if o == nil || IsNil(o.SharedDataList) {
		var ret []SharedData
		return ret
	}
...
// SetSharedDataList gets a reference to the given []SharedData and assigns it to the SharedDataList field.
...
func (o *AccessAndMobilitySubscriptionData) GetQmcConfigInfo() QmcConfigInfo {
	if o == nil || IsNil(o.QmcConfigInfo) {
...
func (o *AccessAndMobilitySubscriptionData) GetMbsrOperationAllowed() MbsrOperationAllowed {
	if o == nil || IsNil(o.MbsrOperationAllowed) {
...
func (o *AccessAndMobilitySubscriptionData) GetLadnServiceAreas() map[string]DnnLadnServiceAreas {
	if o == nil || IsNil(o.LadnServiceAreas) {
...
func (o AccessAndMobilitySubscriptionData) ToMap() (map[string]interface{}, error) {
	...
	if o.SubscribedUeAmbr.IsSet() {
		toSerialize["subscribedUeAmbr"] = o.SubscribedUeAmbr.Get()
	}
	if o.Nssai.IsSet() {
	...
	if !IsNil(o.Aun3DeviceConnectivityAllowed) {
