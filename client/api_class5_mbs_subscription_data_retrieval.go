...
func (r ApiGetMbsDataRequest) Execute() (*MbsSubscriptionData, *http.Response, error) {
...
func (a *Class5MBSSubscriptionDataRetrievalAPIService) GetMbsDataExecute(r ApiGetMbsDataRequest) (*MbsSubscriptionData, *http.Response, error) {
	var (
