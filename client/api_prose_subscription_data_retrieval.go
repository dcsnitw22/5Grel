...
func (r ApiGetProseDataRequest) Execute() (*ProseSubscriptionData, *http.Response, error) {
...
func (a *ProseSubscriptionDataRetrievalAPIService) GetProseDataExecute(r ApiGetProseDataRequest) (*ProseSubscriptionData, *http.Response, error) {
	var (
