...
type _AcknowledgeInfo AcknowledgeInfo
...
func (o *AcknowledgeInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAcknowledgeInfo := _AcknowledgeInfo{}

	err = json.Unmarshal(bytes, &varAcknowledgeInfo)

	if err != nil {
		return err
	}

	*o = AcknowledgeInfo(varAcknowledgeInfo)
