...
func (r ApiGetLcsBcaDataRequest) PlmnId(plmnId PlmnId) ApiGetLcsBcaDataRequest {
	r.plmnId = &plmnId
	return r
}
...
func (r ApiGetLcsBcaDataRequest) Execute() (*LcsBroadcastAssistanceTypesData, *http.Response, error) {
...
func (a *LCSBroadcastAssistanceDataTypesRetrievalAPIService) GetLcsBcaDataExecute(r ApiGetLcsBcaDataRequest) (*LcsBroadcastAssistanceTypesData, *http.Response, error) {
	var (
