...
type _ProSeAllowedPlmn ProSeAllowedPlmn
...
func (o *ProSeAllowedPlmn) UnmarshalJSON(bytes []byte) (err error) {
	...
	varProSeAllowedPlmn := _ProSeAllowedPlmn{}

	err = json.Unmarshal(bytes, &varProSeAllowedPlmn)

	if err != nil {
		return err
	}

	*o = ProSeAllowedPlmn(varProSeAllowedPlmn)
