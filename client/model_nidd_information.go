...
type _NiddInformation NiddInformation
...
func (o *NiddInformation) UnmarshalJSON(bytes []byte) (err error) {
	...
	varNiddInformation := _NiddInformation{}

	err = json.Unmarshal(bytes, &varNiddInformation)

	if err != nil {
		return err
	}

	*o = NiddInformation(varNiddInformation)
