...
func (r ApiGetDataSetsRequest) AdjacentPlmns(adjacentPlmns []PlmnId) ApiGetDataSetsRequest {
	r.adjacentPlmns = &adjacentPlmns
	return r
}

func (r ApiGetDataSetsRequest) SingleNssai(singleNssai Snssai) ApiGetDataSetsRequest {
...
func (r ApiGetDataSetsRequest) UcPurpose(ucPurpose UcPurpose) ApiGetDataSetsRequest {
