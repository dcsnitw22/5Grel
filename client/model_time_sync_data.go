...
// GetClockQualityAcceptanceCriteria returns the ClockQualityAcceptanceCriteria field value if set, zero value otherwise.
func (o *TimeSyncData) GetClockQualityAcceptanceCriteria() []ClockQualityAcceptanceCriterion {
	if o == nil || IsNil(o.ClockQualityAcceptanceCriteria) {
		var ret []ClockQualityAcceptanceCriterion
		return ret
	}
	return o.ClockQualityAcceptanceCriteria
}

// GetClockQualityAcceptanceCriteriaOk returns a tuple with the ClockQualityAcceptanceCriteria field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TimeSyncData) GetClockQualityAcceptanceCriteriaOk() ([]ClockQualityAcceptanceCriterion, bool) {
	if o == nil || IsNil(o.ClockQualityAcceptanceCriteria) {
		return nil, false
	}
	return o.ClockQualityAcceptanceCriteria, true
}
...
// SetClockQualityAcceptanceCriteria gets a reference to the given []ClockQualityAcceptanceCriterion and assigns it to the ClockQualityAcceptanceCriteria field.
func (o *TimeSyncData) SetClockQualityAcceptanceCriteria(v []ClockQualityAcceptanceCriterion) {
	o.ClockQualityAcceptanceCriteria = v
}
...
func (o TimeSyncData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ClockQualityAcceptanceCriteria) {
		toSerialize["clockQualityAcceptanceCriteria"] = o.ClockQualityAcceptanceCriteria
	}
	return toSerialize, nil
}

func (o *TimeSyncData) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTimeSyncData)
