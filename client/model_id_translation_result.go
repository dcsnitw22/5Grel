...
type _IdTranslationResult IdTranslationResult
...
func (o *IdTranslationResult) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIdTranslationResult := _IdTranslationResult{}

	err = json.Unmarshal(bytes, &varIdTranslationResult)

	if err != nil {
		return err
	}

	*o = IdTranslationResult(varIdTranslationResult)
