...
type _ServiceTypeUnrelatedClass ServiceTypeUnrelatedClass
...
func (o *ServiceTypeUnrelatedClass) UnmarshalJSON(bytes []byte) (err error) {
	...
	varServiceTypeUnrelatedClass := _ServiceTypeUnrelatedClass{}

	err = json.Unmarshal(bytes, &varServiceTypeUnrelatedClass)

	if err != nil {
		return err
	}

	*o = ServiceTypeUnrelatedClass(varServiceTypeUnrelatedClass)
