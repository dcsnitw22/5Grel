...
type _AerialUeSubscriptionInfo AerialUeSubscriptionInfo
...
func (o *AerialUeSubscriptionInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAerialUeSubscriptionInfo := _AerialUeSubscriptionInfo{}

	err = json.Unmarshal(bytes, &varAerialUeSubscriptionInfo)

	if err != nil {
		return err
	}

	*o = AerialUeSubscriptionInfo(varAerialUeSubscriptionInfo)
