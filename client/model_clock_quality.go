...
// GetClockAccuracy returns the ClockAccuracy field value if set, zero value otherwise.
func (o *ClockQuality) GetClockAccuracy() string {
	if o == nil || IsNil(o.ClockAccuracy) {
		var ret string
		return ret
	}
	return *o.ClockAccuracy
}

// GetClockAccuracyOk returns a tuple with the ClockAccuracy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClockQuality) GetClockAccuracyOk() (*string, bool) {
	if o == nil || IsNil(o.ClockAccuracy) {
		return nil, false
	}
	return o.ClockAccuracy, true
}
...
// SetClockAccuracy gets a reference to the given string and assigns it to the ClockAccuracy field.
...
func (o ClockQuality) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ClockAccuracy) {
		toSerialize["clockAccuracy"] = o.ClockAccuracy
	}
