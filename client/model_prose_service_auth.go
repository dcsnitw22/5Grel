...
func (o *ProseServiceAuth) GetProseMultipathComL2RemoteAuth() UeAuth {
	if o == nil || IsNil(o.ProseMultipathComL2RemoteAuth) {
		var ret UeAuth
		return ret
	}
...
func (o *ProseServiceAuth) GetProseL2UeRelayAuth() UeAuth {
	if o == nil || IsNil(o.ProseL2UeRelayAuth) {
		var ret UeAuth
		return ret
	}
...
func (o *ProseServiceAuth) GetProseL3UeRelayAuth() UeAuth {
	if o == nil || IsNil(o.ProseL3UeRelayAuth) {
		var ret UeAuth
		return ret
	}
...
func (o *ProseServiceAuth) GetProseL2EndAuth() UeAuth {
	if o == nil || IsNil(o.ProseL2EndAuth) {
		var ret UeAuth
		return ret
	}
...
func (o *ProseServiceAuth) GetProseL3EndAuth() UeAuth {
	if o == nil || IsNil(o.ProseL3EndAuth) {
		var ret UeAuth
		return ret
	}
