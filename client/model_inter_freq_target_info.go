...
type _InterFreqTargetInfo InterFreqTargetInfo
...
func (o *InterFreqTargetInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varInterFreqTargetInfo := _InterFreqTargetInfo{}

	err = json.Unmarshal(bytes, &varInterFreqTargetInfo)

	if err != nil {
		return err
	}

	*o = InterFreqTargetInfo(varInterFreqTargetInfo)
